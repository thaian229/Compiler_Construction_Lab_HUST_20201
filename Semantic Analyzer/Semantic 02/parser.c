...
void compileProgram(void)
{
    ...
    // create
    // TODO CHECK
    program = createProgramObject(currentToken->string); // ident is the param here
    // enter
...
{
    // DONE: create and declare a function object with enter and exit scope
    Object *funcObj;
    Type *returnType;
...
void compileParam(void)
{
    ...
    switch (lookAhead->tokenType) // set up paramKind
    {
    case TK_IDENT:
